...
if __name__ == '__main__':
    dataset_dir = "G:/For_EEG/EEG_code/4 （论文加代码）基于CNN和LSTM的脑电情绪识别（数据集为DEAP和seed）4D-CRNN/4D-CRNN-master/DEAP1/all_0.5/"
    use_baseline = "yes"
    if use_baseline == "yes":
        result_dir = "G:/For_EEG/EEG_code/4 （论文加代码）基于CNN和LSTM的脑电情绪识别（数据集为DEAP和seed）4D-CRNN/4D-CRNN-master/DEAP1/with_base_0.5/"
        if os.path.isdir(result_dir) == False:
            os.makedirs(result_dir)
    else:
        result_dir = "G:/For_EEG/EEG_code/4 （论文加代码）基于CNN和LSTM的脑电情绪识别（数据集为DEAP和seed）4D-CRNN/4D-CRNN-master/DEAP1/without_base_0.5/"
        if os.path.isdir(result_dir) == False:
            os.makedirs(result_dir)
