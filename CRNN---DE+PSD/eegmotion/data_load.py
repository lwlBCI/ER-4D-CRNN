...
def load_data(dataset_dir, subject_n=32, img_size=(8, 9, 8), number_of_inputs=1,
    ...
    for i in range(subject_n):
        ...
        # print("one_falx.shape:",one_falx.shape) 4800,8,9,8
    ...
    # print("1,2,3,4:",y_a_all_subject.shape,y_v_all_subject.shape,x_all_subject.shape,all_subject_id.shape)
    # (153600, 2) (153600, 2) (153600, 1, 8, 9, 8) (153600,)
