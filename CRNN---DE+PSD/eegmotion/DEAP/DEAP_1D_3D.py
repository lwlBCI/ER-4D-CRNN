...
if __name__ == '__main__':
    dataset_dir = "G:/For_EEG/multi/multi-task-cnn-eeg-emotion-main/eegemotion/DEAP_data/all_0.5/"
    use_baseline = "yes"
    if use_baseline == "yes":
        result_dir = "G:/For_EEG/multi/multi-task-cnn-eeg-emotion-main/eegemotion/DEAP_data/with_base_0.5/"
        if os.path.isdir(result_dir) == False:
            os.makedirs(result_dir)
    else:
        result_dir = "G:/For_EEG/multi/multi-task-cnn-eeg-emotion-main/eegemotion/DEAP_data/without_base_0.5/"
        if os.path.isdir(result_dir) == False:
            os.makedirs(result_dir)
